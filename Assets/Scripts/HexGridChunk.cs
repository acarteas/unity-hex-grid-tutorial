...
public class HexGridChunk : MonoBehaviour
{
    ...
    private const float one_sixth = 1 / 6f;
    private const float two_thirds = 2 / 3f;
    ...
    )
    {
        ...
        //AC: this code might only be at TriangulateWithRiverBeginOrEnd
    ...
    )
    {
        ...
        {
            centerL = center;
            centerR = Vector3.Lerp(center, e.v5, two_thirds);
        }
        else if (cell.HasRiverThroughEdge(direction.Previous()))
        {
            centerL = Vector3.Lerp(center, e.v1, two_thirds);
            centerR = center;
        }
    ...
    {
        //AC: might be wrong place for this, instead may be at TriangualteAdjacentToRiver
        if (cell.HasRiverThroughEdge(direction.Next()))
        {
            if (cell.HasRiverThroughEdge(direction.Previous()))
            {
